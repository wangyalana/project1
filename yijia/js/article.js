...
function loadArticleDetail(){
	...
	if(getUrlParams("type")){
		...
		//alert(result.data.coverImg);
		$(".company-font").html(result.data.typeTitle);
		$(".company-english").html(result.data.typeEntitle);
		$('.feicui-font').text(result.data.title); 	
		$('.article-shuzi').text(result.data.updateAt);	
		$('.article-img .cover-img').attr("src",result.data.coverImg); 	 	
